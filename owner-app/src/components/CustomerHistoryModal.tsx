...
const STRINGS = {
  ...
  olderNote: {
    en: "Purchases older than the detail window show as a total only, in Reports — item detail isn't kept forever.",
    ta: "விவர காலத்தை விட பழையவை அறிக்கைகளில் மொத்தமாக மட்டுமே காட்டப்படும் — பொருள் விவரம் எப்போதும் வைக்கப்படாது.",
  },
};
